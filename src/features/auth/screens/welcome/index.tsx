    ...
    return (<LinearGradient colors={['#CBECBD', '#EEF7F2']}
        ...
        <SafeAreaView style={styles.container}>
            <View style={{ gap: 30 }}>
                ...
                <Text style={{ textAlign: "center" }} variant="hero">Proactive Healthcare</Text>
                <Text style={{ textAlign: "center" }} variant="caption">Monitor, remind, and take care of your health everyday.</Text>
            </View>
            <View style={{ gap: 23, width: "100%", justifyContent: "center", alignItems: "center" }}>
                ...
                <Text variant="body">
                    Don't have an account yet? <Text variant="link" onPress={() => navigation.navigate("Auth", { screen: "SignUp" })}>Register now!</Text>
                </Text>
            </View>
        </SafeAreaView>
    </LinearGradient>)
